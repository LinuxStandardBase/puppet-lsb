class buildbot::slave inherits buildbot {
    ...
    $betasdk = "${architecture}-${wordsize}" ? {
        /^i386/         => 'lsb-sdk-4.1.90-1.ia32.tar.gz',
        /^x86_64/       => 'lsb-sdk-4.1.90-1.x86_64.tar.gz',
        /^ia64/         => 'lsb-sdk-4.1.90-1.ia64.tar.gz',
        /^s390x-small$/ => 'lsb-sdk-4.1.90-1.s390.tar.gz',
        /^s390x-big$/   => 'lsb-sdk-4.1.90-1.s390x.tar.gz',
        /^ppc64-small$/ => 'lsb-sdk-4.1.90-1.ppc32.tar.gz',
        /^ppc64-big$/   => 'lsb-sdk-4.1.90-1.ppc64.tar.gz',
    }
